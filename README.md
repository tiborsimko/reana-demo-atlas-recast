...
[RECAST](https://arxiv.org/abs/1010.2506) analysis using
[ATLAS](https://atlas.cern/) Analysis Software Group stack.
...
[eventselection](eventselection) subdirectory. It uses the official analysis
...
[statanalysis](statanalysis) subdirectory. It implements limit setting for
...
a [Docker](https://www.docker.com/) container image for our analysis steps.

The event selection stage uses official ATLAS `atlas/analysisbase` container on
top of which we add and build our custom code:
...
the computational steps in a declarative manner:

![image](https://raw.githubusercontent.com/reanahub/reana-demo-atlas-recast/master/docs/workflow.png)
...
![image](https://raw.githubusercontent.com/reanahub/reana-demo-atlas-recast/master/statanalysis/example_results/pre.png)

![image](https://raw.githubusercontent.com/reanahub/reana-demo-atlas-recast/master/statanalysis/example_results/post.png)

The limit plot:

![image](https://raw.githubusercontent.com/reanahub/reana-demo-atlas-recast/master/statanalysis/example_results/limit.png)
